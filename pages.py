...
home_page_main_content = Div(
    ...
    P("A Paulada é um esporte de combate um contra um, onde dois adversários se enfrentam usando espadas, geralmente feitas de madeira leve ou cabos de vassoura. O objetivo principal é simples em essência: acertar a parte inferior do corpo do oponente (pernas, joelhos, canelas ou pés) para marcar pontos. A simplicidade das regras esconde uma camada profunda de estratégia, exigindo movimentos rápidos, esquivas precisas e ataques calculados.", cls='visible'),
    P(
    ...
    P(
        Em(
            "Nota: apesar de apresentar um baixo risco, ",
            Strong("ele ainda é presente. "),
